# XCalender
'XCalendar' is a  **swift package for calender view** to for an iOS application, which supports from **iOS 10** version. This library has the functionality to navigate between months and selection of dates from the calendar. 

### Ussage
```
class ViewController: UIViewController {
    @IBOutlet weak var calenderView: XCallenderView?
